...
# Copyright (c) 2019 Vedernikov Sergey
# e-mail: Sergey15th13@gmail.com:
# VCard QR Code generation capability
#       adapting for Inkscape extension, SVG output, Auto mode
#
...
class QRCodeInkscape(inkex.Effect):
    def __init__(self):
        ...
        #PARSE OPTIONS
        self.OptionParser.add_option("--text_surname",
            action="store", type="string",
            dest="TEXT_SURNAME", default='LastName')
        self.OptionParser.add_option("--text_name",
            action="store", type="string",
            dest="TEXT_NAME", default='Name')
        self.OptionParser.add_option("--text_mname",
            action="store", type="string",
            dest="TEXT_MNAME", default=' ')
        self.OptionParser.add_option("--text_organization",
            action="store", type="string",
            dest="TEXT_ORGANIZATION", default='Organization')
        self.OptionParser.add_option("--text_title",
            action="store", type="string",
            dest="TEXT_TITLE", default='Title')
        self.OptionParser.add_option("--text_phone",
            action="store", type="string",
            dest="TEXT_PHONE", default='+0123456789')
        self.OptionParser.add_option("--text_email",
            action="store", type="string",
            dest="TEXT_EMAIL", default='e@mail.com')
        self.OptionParser.add_option("--text_site",
            action="store", type="string",
            dest="TEXT_SITE", default=' ')
        ...
        self.OptionParser.add_option("--decoding",
            action="store", type="string",
            dest="input_decode", default="latin_1")
